...
"""
def summarize_results(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
def join_summarize_results(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('join_summarize_results() called')

    # check if all connected incoming actions are done i.e. have succeeded or failed
    if phantom.actions_done([ 'whois_ip_dst', 'whois_ip_src', 'whois_sourceAddress', 'whois_destAddress', 'whois_source_ip', 'whois_dest_ip', 'whois_url_ip' ]):
...
def filter_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_2 or matched_results_2:
        geolocate_destAddress(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_2, filtered_results=matched_results_2)
    ...
    if matched_artifacts_3 or matched_results_3:
        geolocate_ip_dst(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_3, filtered_results=matched_results_3)
    ...
    if matched_artifacts_4 or matched_results_4:
        geolocate_ip_src(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_4, filtered_results=matched_results_4)
...
def filter_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks if filtered artifacts or results
    if matched_artifacts_1 or matched_results_1:
        lookup_dest_domain(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
    ...
    # call connected blocks if filtered artifacts or results
    if matched_artifacts_2 or matched_results_2:
        lookup_ip_for_url(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_2, filtered_results=matched_results_2)
    ...
    # call connected blocks if filtered artifacts or results
    if matched_artifacts_3 or matched_results_3:
        lookup_source_domain(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_3, filtered_results=matched_results_3)
...
"""
def lookup_source_domain(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("lookup domain", parameters=parameters, assets=['dns'], callback=geolocate_source, name="lookup_source_domain")
...
"""
def lookup_dest_domain(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("lookup domain", parameters=parameters, assets=['dns'], callback=geolocate_dest, name="lookup_dest_domain")
...
"""
def lookup_ip_for_url(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
"""
def geolocate_ip_src(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_ip_src, name="geolocate_ip_src")
...
def geolocate_sourceAddress(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_sourceAddress, name="geolocate_sourceAddress")
...
"""
def whois_ip_src(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_ip_src", parent_action=action)
...
"""
def whois_destAddress(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_destAddress", parent_action=action)
...
"""
def geolocate_destAddress(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_destAddress, name="geolocate_destAddress")
...
"""
def geolocate_source(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('geolocate_source() called')
    
    #phantom.debug('Action: {0} {1}'.format(action['name'], ('SUCCEEDED' if success else 'FAILED')))
    
    # collect data for 'geolocate_source' call
    results_data_1 = phantom.collect2(container=container, datapath=['lookup_source_domain:action_result.summary.ip', 'lookup_source_domain:action_result.parameter.context.artifact_id'], action_results=results)
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_source_ip, name="geolocate_source", parent_action=action)
...
Geolocate the resolved IP address using Maxmind
"""
def geolocate_dest(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('geolocate_dest() called')
    
    #phantom.debug('Action: {0} {1}'.format(action['name'], ('SUCCEEDED' if success else 'FAILED')))
    
    # collect data for 'geolocate_dest' call
    results_data_1 = phantom.collect2(container=container, datapath=['lookup_dest_domain:action_result.summary.ip', 'lookup_dest_domain:action_result.parameter.context.artifact_id'], action_results=results)
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_dest_ip, name="geolocate_dest", parent_action=action)
...
Geolocate the resolved IP address using Maxmind
"""
def geolocate_url(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('geolocate_url() called')
    
    #phantom.debug('Action: {0} {1}'.format(action['name'], ('SUCCEEDED' if success else 'FAILED')))
    
    # collect data for 'geolocate_url' call
    results_data_1 = phantom.collect2(container=container, datapath=['lookup_ip_for_url:action_result.summary.ip', 'lookup_ip_for_url:action_result.parameter.context.artifact_id'], action_results=results)
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_url_ip, name="geolocate_url", parent_action=action)
...
def whois_sourceAddress(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_sourceAddress", parent_action=action)
...
"""
def whois_source_ip(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_source_ip", parent_action=action)
...
WHOIS lookup on the resolved IP address
"""
def whois_dest_ip(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_dest_ip", parent_action=action)
...
WHOIS lookup on the resolved IP address
"""
def whois_url_ip(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_url_ip", parent_action=action)
...
"""
def geolocate_ip_dst(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("geolocate ip", parameters=parameters, assets=['maxmind'], callback=whois_ip_dst, name="geolocate_ip_dst")
...
"""
def whois_ip_dst(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=join_summarize_results, name="whois_ip_dst", parent_action=action)
...
"""
def check_internal_addresses(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
