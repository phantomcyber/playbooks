...
"""
def filter_hash_and_ip(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_3 or matched_results_3:
        file_intelligence_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_3, filtered_results=matched_results_3)
...
"""
def filter_domain_and_url(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks if filtered artifacts or results
    if matched_artifacts_1 or matched_results_1:
        domain_intel_dest_dns(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
    ...
    # call connected blocks if filtered artifacts or results
    if matched_artifacts_2 or matched_results_2:
        url_intelligence_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_2, filtered_results=matched_results_2)
...
"""
def ip_intel_source_address(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("ip intelligence", parameters=parameters, assets=['recorded_future'], name="ip_intel_source_address")
...
"""
def ip_intel_destination_address(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("ip intelligence", parameters=parameters, assets=['recorded_future'], name="ip_intel_destination_address")
...
def file_intelligence_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("file intelligence", parameters=parameters, assets=['recorded_future'], name="file_intelligence_1")
...
"""
def domain_intel_source_dns(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("domain intelligence", parameters=parameters, assets=['recorded_future'], name="domain_intel_source_dns")
...
"""
def domain_intel_dest_dns(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("domain intelligence", parameters=parameters, assets=['recorded_future'], name="domain_intel_dest_dns")
...
def url_intelligence_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("url intelligence", parameters=parameters, assets=['recorded_future'], name="url_intelligence_1")
