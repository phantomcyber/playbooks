...
def revert_vm_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    filter_results_data_1 = phantom.collect2(container=container, datapath=["get_system_info_1:filtered-action_result.data.*.vmx_path", "get_system_info_1:filtered-action_result.parameter.context.artifact_id"], action_results=filtered_results)

    parameters = []
    
    # build parameters list for 'revert_vm_1' call
    for filter_results_item_1 in filter_results_data_1:
        if filter_results_item_1[0]:
            parameters.append({
                'snapshot': "",
                'vmx_path': filter_results_item_1[0],
                # context (artifact id) is added to associate results with the artifact
                'context': {'artifact_id': filter_results_item_1[1]},
            })
...
def terminate_process_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    filter_results_data_1 = phantom.collect2(container=container, datapath=["get_system_info_1:filtered-action_result.data.*.vm_hostname", "get_system_info_1:filtered-action_result.parameter.context.artifact_id"], action_results=filtered_results)
    ...
    for filter_results_item_1 in filter_results_data_1:
        if filter_results_item_1[0]:
            parameters.append({
                'ip_hostname': filter_results_item_1[0],
                'sensor_id': "",
                'pid': "",
                # context (artifact id) is added to associate results with the artifact
                'context': {'artifact_id': filter_results_item_1[1]},
...
def get_system_info_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    filter_results_data_1 = phantom.collect2(container=container, datapath=["get_system_info_1:filtered-action_result.data.*.ip", "get_system_info_1:filtered-action_result.parameter.context.artifact_id"], action_results=filtered_results)
