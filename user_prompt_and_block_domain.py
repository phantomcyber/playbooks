...
def prompt_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.prompt(container=container, user=user, message=message, respond_in_mins=60, name="prompt_1", parameters=parameters, options=options, callback=decision_3)
