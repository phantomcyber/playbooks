...
"""
def get_devices_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get devices", parameters=parameters, assets=['extrahop'], callback=decision_1, name="get_devices_1")
...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_1 or matched_results_1:
        get_device_info_1(action=action, success=success, container=container, results=results, handle=handle)
        list_nessus_policies(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def get_device_info_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get device info", parameters=parameters, assets=['extrahop'], callback=get_device_info_1_callback, name="get_device_info_1")

    return

def get_device_info_1_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('get_device_info_1_callback() called')
    
    get_peers_1(action=action, success=success, container=container, results=results, handle=handle)
    get_protocols_1(action=action, success=success, container=container, results=results, handle=handle)
...
"""
def get_protocols_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get protocols", parameters=parameters, assets=['extrahop'], name="get_protocols_1", parent_action=action)
...
"""
def get_peers_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get peers", parameters=parameters, assets=['extrahop'], name="get_peers_1", parent_action=action)
...
"""
def scan_endpoint_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    for results_item_1 in results_data_1:
        for filtered_results_item_1 in filtered_results_data_1:
            if results_item_1[0] and filtered_results_item_1[0]:
                parameters.append({
    ...
    phantom.act("scan endpoint", parameters=parameters, assets=['nessus'], name="scan_endpoint_1")
...
"""
def Nessus_Policy_Name(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_1 or matched_results_1:
        scan_endpoint_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
...
"""
def list_nessus_policies(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("list policies", parameters=parameters, assets=['nessus'], callback=Nessus_Policy_Name, name="list_nessus_policies")
