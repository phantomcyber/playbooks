...
"""
def format_related_ip_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
"""
def build_ip_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("run query", parameters=parameters, assets=['splunk'], callback=search_splunk_for_ips, name="build_ip_lookup")
...
def send_email_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("send email", parameters=parameters, assets=['smtp_gmail'], name="send_email_1")
...
Build a Splunk query to turn a list of related entities from Recorded Future into a lookup table that can be used for threat hunting across any sourcetype or data model
"""
def format_related_domain_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Run the Splunk query that creates the lookup file
"""
def build_domain_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("run query", parameters=parameters, assets=['splunk'], callback=search_splunk_for_domains, name="build_domain_lookup")
...
Build a Splunk query to turn a list of related entities from Recorded Future into a lookup table that can be used for threat hunting across any sourcetype or data model
"""
def format_related_hash_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Run the Splunk query that creates the lookup file
"""
def build_hash_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("run query", parameters=parameters, assets=['splunk'], callback=search_splunk_for_files, name="build_hash_lookup")
...
Build a Splunk query to turn a list of related entities from Recorded Future into a lookup table that can be used for threat hunting across any sourcetype or data model
"""
def format_related_vuln_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Run the Splunk query that creates the lookup file
"""
def build_vuln_lookup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("run query", parameters=parameters, assets=['splunk'], callback=search_splunk_for_vulns, name="build_vuln_lookup")
...
def ip_intelligence_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("ip intelligence", parameters=parameters, assets=['recorded_future'], callback=Entity_Type_Filter, name="ip_intelligence_1")
...
def Entity_Type_Filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_1 or matched_results_1:
        format_related_hash_lookup(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
    ...
    if matched_artifacts_2 or matched_results_2:
        format_related_vuln_lookup(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_2, filtered_results=matched_results_2)
    ...
    if matched_artifacts_3 or matched_results_3:
        format_related_ip_lookup(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_3, filtered_results=matched_results_3)
    ...
    if matched_artifacts_4 or matched_results_4:
        format_related_domain_lookup(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_4, filtered_results=matched_results_4)
...
def ip_reputation_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("ip reputation", parameters=parameters, assets=['recorded_future'], callback=risk_score_threshold, name="ip_reputation_1")
