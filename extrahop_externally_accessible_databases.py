...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_1 or matched_results_1:
        get_db_device_info(action=action, success=success, container=container, results=results, handle=handle)
        get_client_device_info(action=action, success=success, container=container, results=results, handle=handle)
        block_client_ip(action=action, success=success, container=container, results=results, handle=handle)
        return
...
"""
def get_db_device_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get device info", parameters=parameters, assets=['extrahop'], callback=get_db_device_info_callback, name="get_db_device_info")

    return

def get_db_device_info_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('get_db_device_info_callback() called')
    
    get_db_peers(action=action, success=success, container=container, results=results, handle=handle)
    get_db_protocols(action=action, success=success, container=container, results=results, handle=handle)
...
"""
def get_client_device_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get device info", parameters=parameters, assets=['extrahop'], callback=get_client_device_info_callback, name="get_client_device_info")

    return

def get_client_device_info_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('get_client_device_info_callback() called')
    
    get_client_peers(action=action, success=success, container=container, results=results, handle=handle)
    get_client_protocols(action=action, success=success, container=container, results=results, handle=handle)
...
"""
def get_db_peers(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get peers", parameters=parameters, assets=['extrahop'], name="get_db_peers", parent_action=action)
...
"""
def get_db_protocols(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get protocols", parameters=parameters, assets=['extrahop'], name="get_db_protocols", parent_action=action)
...
Retrieves a list of all of the peers that a device communicated with in the last 30 minutes
"""
def get_client_peers(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get peers", parameters=parameters, assets=['extrahop'], name="get_client_peers", parent_action=action)
...
Retrieves a list of all of the protocols that a device communicated over the last 30 minutes
"""
def get_client_protocols(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("get protocols", parameters=parameters, assets=['extrahop'], name="get_client_protocols", parent_action=action)
...
"""
def block_client_ip(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("block ip", parameters=parameters, assets=['pan'], name="block_client_ip")
