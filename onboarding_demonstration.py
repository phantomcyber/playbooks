...
def url_reputation_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("url reputation", parameters=parameters, assets=['phishtank'], callback=phishtank_filter, name="url_reputation_1")
...
"""
def lookup_domain_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
