"""
This is a playbook that is designed to be recommended within a Workbook. If used in this manner, the playbook will assign the user that launched the playbook as the owner of the event, move the status to Open, and close the Workbook task where this playbook appears. If there is a task after the one where the playbook appears, it will set the next task to &quot;in progress.&quot;
"""
...
def update_workbook_tasks(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    ################################################################################
    # Custom code to determine which task this playbook occurs and then updates that 
    # task and any that immediately follows that task.
    ################################################################################
