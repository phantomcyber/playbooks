def string_base85(input_data=None, mode=None, **kwargs):
    """
    Encodes or decodes data using Base85. Works with both str and bytes.
    ...
    def base85_transform(data, mode='encode'):
        """
        ...
        try:
            ...
            raise ValueError(f"Base85 {mode} failed: {e}")
        
    result = base85_transform(input_data, mode)
