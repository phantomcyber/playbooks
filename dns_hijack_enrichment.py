...
"""
def filter_query(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
def whois_ip(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("whois ip", parameters=parameters, assets=['whois'], callback=whois_ip_callback, name="whois_ip", parent_action=action)

    return

def whois_ip_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('whois_ip_callback() called')
    
    censys_lookup_ip(action=action, success=success, container=container, results=results, handle=handle)
    ip_reputation_2(action=action, success=success, container=container, results=results, handle=handle)
...
def join_format_results(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if phantom.actions_done([ 'lookup_certificate_1', 'ip_reputation_2', 'domain_reputation_1', 'domain_reputation_2' ]):
...
def domain_reputation_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("domain reputation", parameters=parameters, assets=['passivetotal'], callback=join_format_results, name="domain_reputation_2")
